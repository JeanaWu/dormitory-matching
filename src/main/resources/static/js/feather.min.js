!function (e, n) {
    ...
    return function (e) {
        ...
        var t = i(1), l = i(7), r = i(8), o = i(10), a = i(11), c = function (e, n, i) {
            ...
            u && (i = n);
            for (y in i) p = !s && g && void 0 !== g[y], h = (p ? g : i)[y], x = v && p ? a(h, t) : d && "function" == typeof h ? a(Function.call, h) : h, g && o(g, y, h, e & c.U), m[y] != h && r(m, y, x), d && M[y] != h && (M[y] = h)
        };
        ...
        e.exports = function (e, n, i, f, d, v, g) {
            ...
            if (O && (w = h(O.call(new e))) !== Object.prototype && w.next && (p(w, A, !0), t || a(w, x) || o(w, x, u)), _ && S && "values" !== S.name && (z = !0, H = function () {
                return S.call(this)
            }), t && !g || !s && !z && k[x] || o(k, x, H), c[n] = H, c[A] = u, d) if (m = {
                values: _ ? H : b("values"),
                keys: v ? H : b("keys"),
                entries: V
            }, g) for (M in m) M in k || r(k, M, m[M]); else l(l.P + l.F * (s || z), n, m);
            return m
        }
    }, function (e, n, i) {
        var t = i(55), l = i(37);
...
*/
        ...
        l(l.S + l.F * !i(41)(function (e) {
            ...
            from: function (e) {
                ...
                if (d && (f = t(f, u > 2 ? arguments[2] : void 0, 2)), void 0 == g || s == Array && a(g)) for (n = c(x.length), i = new s(n); n > v; v++) y(i, v, d ? f(x[v], v) : x[v]); else for (h = g.call(x), i = new s; !(l = h.next()).done; v++) y(i, v, d ? o(h, f, [l.value, v], !0) : l.value);
                return i.length = v, i
            }
        })
    }, function (e, n, i) {
        ...
        e.exports = !c || i(12)(function () {
            ...
            for (var i = o(e), c = arguments.length, y = 1, p = l.f, h = r.f; c > y;) for (var x, s = a(arguments[y++]), u = p ? t(s).concat(p(s)) : t(s), f = u.length, d = 0; f > d;) h.call(s, x = u[d++]) && (i[x] = s[x]);
            return i
        } : c
    }, function (e, n) {
        ...
        for (var t = i(69), l = i(21), r = i(10), o = i(1), a = i(8), c = i(13), y = i(0), p = y("iterator"), h = y("toStringTag"), x = c.Array, s = {
            ...
            if (M && (M[p] || a(M, p, x), M[h] || a(M, h, v), c[v] = x, g)) for (d in t) M[d] || r(M, d, t[d], !0)
        }
    }, function (e, n, i) {
        "use strict";
        ...
        e.exports = function (e, n, i, f, d, v) {
            ...
            } else m = f.getConstructor(n, e, d, M), o(m.prototype, i), a.NEED = !0;
